...
WireTextEditor.Modes.E2.SyntaxColors = colors
...
function WireTextEditor.Modes.E2:SyntaxColorLine(row)
  cols,lastcol = {}, nil
...
function WireTextEditor.Modes.E2:BlockCommentSelection(removecomment)
